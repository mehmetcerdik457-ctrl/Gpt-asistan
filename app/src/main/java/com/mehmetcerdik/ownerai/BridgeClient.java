...
public final class BridgeClient {
    ...
    public static String getBridgeSigner(Context c) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                PackageInfo pi = pm.getPackageInfo(BRIDGE_PACKAGE, PackageManager.GET_SIGNING_CERTIFICATES);
    ...
    public static boolean verifyBridge(Context c) {
        String s = getBridgeSigner(c);
        return s != null && EXPECTED_SIGNER.equalsIgnoreCase(s);
    }
